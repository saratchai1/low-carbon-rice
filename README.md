...
Sentinel-2 แต่ละวันจะรวม MGRS tile ที่ตัดผ่านพื้นที่เป้าหมายเป็น mosaic
บนกริดเดียวกันก่อนคำนวณ NDVI, EVI, LSWI และ NDWI เพื่อป้องกันภาพเหลื่อม
หรือขาดบางส่วนบริเวณรอยต่อ tile
